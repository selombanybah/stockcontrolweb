...
--
-- Servidor: localhost
-- Tiempo de generación: 28-06-2010 a las 22:19:21
...
--
CREATE DATABASE `stockcontrol` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `stockcontrol`;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Cargos de empleados' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Categorias principales de producto' AUTO_INCREMENT=1 ;
...
CREATE TABLE `cliente` (
  ...
  `dni` varchar(30) collate utf8_unicode_ci default NULL COMMENT 'DNI del Cliente',
  ...
  `ciudad` varchar(255) collate utf8_unicode_ci default NULL COMMENT 'Cuidad del Cliente',
  `direccion` text collate utf8_unicode_ci COMMENT 'Direccion del Cliente',
  `telefono` varchar(255) collate utf8_unicode_ci default NULL COMMENT 'Telefono del Cliente',
  `fechaNacimiento` date default NULL COMMENT 'Fecha de Nacimiento del Cliente',
  `genero` tinyint(1) unsigned default '0' COMMENT 'Género: 0 = No definido,  1 = Femenino, 2 = Masculino',
  `scorePositive` int(10) default '0' COMMENT 'Puntos positivos acumulador por el cliente',
  `scoreNegative` int(10) default '0' COMMENT 'Puntos negativos acumulador por el cliente',
  `eliminado` tinyint(1) unsigned default '0' COMMENT 'Indica si el Cliente fue eliminado',
  PRIMARY KEY  (`id`),
  UNIQUE KEY `cliente_unique` (`idEmpresa`,`numero`),
  KEY `cliente_x_empresa` (`idEmpresa`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Clientes' AUTO_INCREMENT=7 ;

--
-- Volcar la base de datos para la tabla `cliente`
--

INSERT INTO `cliente` (`id`, `idEmpresa`, `numero`, `dni`, `nombre`, `apellido`, `ciudad`, `direccion`, `telefono`, `fechaNacimiento`, `genero`, `scorePositive`, `scoreNegative`, `eliminado`) VALUES
(1, 1, 'CL00001', '28459243', 'Maria Valeria', 'Cardozo', 'Merlo', 'Homero', '4994101', '1980-11-18', 1, 0, 0, 0),
(2, 1, 'CL00002', '30243324', 'Enrique Jose Maria', 'Listorti', 'Johanesburg', 'ASasdas', '5456415345452', '2010-06-01', 2, 0, 0, 0),
(3, 1, 'CL00003', '2341244104', 'Peter', 'Parker', 'NY', 'SpiderCity', '1224141', '2010-06-02', 2, 0, 0, 0),
(4, 1, 'CL00004', '414141414', 'Clark', 'Kent', 'Smallville', 'Kansas', '654789', '2010-06-03', 2, 0, 0, 0),
(5, 1, 'CL00005', '6547893', 'Goku', 'Kakaroto', 'Planeta Tierra', 'Planata', '5454785', '2010-06-05', 2, 0, 0, 0),
(6, 1, 'CL00006', '321454711', 'Flash', 'Gordon', 'Kosto', 'Mirko', '4152454324', '2010-06-07', 2, 0, 0, 0);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Compras' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Compras canceladas' AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `compra_cancelada`
--
...
CREATE TABLE `compra_detalle` (
  ...
  KEY `compra_detalle_x_empresa` (`idEmpresa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Detalles de compra' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Corredores' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Empleados' AUTO_INCREMENT=2 ;

--
-- Volcar la base de datos para la tabla `empleado`
--

INSERT INTO `empleado` (`id`, `idEmpresa`, `numero`, `dni`, `nombre`, `apellido`, `direccion`, `telefono`, `idCargo`, `idTipoUsuario`, `username`, `password`, `eliminado`) VALUES
(1, 1, 'E0001', '30427061', 'Pablo Javier', 'Cianci', 'Homero 4045', '4994101', 1, 1, 'cyberpol', 'iloveyii', 0);
...
CREATE TABLE `empresa` (
  ...
  KEY `empresa_x_empresa` (`idEmpresa`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Empresas' AUTO_INCREMENT=3 ;

--
-- Volcar la base de datos para la tabla `empresa`
--

INSERT INTO `empresa` (`id`, `idEmpresa`, `nombre`, `cuit`, `direccion`, `telefono`, `email`, `counterIdFactura`, `counterIdFacturaTemporal`, `counterNroFactura`, `maxLoginAttempts`, `porcentajeRetencion`, `eliminado`) VALUES
(1, 0, 'FreakSoft', '20-30427061-9', 'Homero 4045 e/ San Fernando y Rauch', '54-0220-499-4101', 'cyberpol_777@hotmail.com', 1, 1, 1, 3, '5.00', 0),
(2, 0, 'JavaSoft', '564574574274', 'Otra dirección', '12342424', 'mail@example.com', 1, 1, 1, 0, '3.00', 0);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Formas de pago para la venta' AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `forma_pago_compra`
--
...
--
-- Volcar la base de datos para la tabla `forma_pago_venta`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Pagos realizados por los clientes' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Pagos realizados a los proveedores' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Productos' AUTO_INCREMENT=1 ;
...
--
-- Volcar la base de datos para la tabla `provee`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Proveedores' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Subcategorias de productos' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Ventas' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Ventas canceladas' AUTO_INCREMENT=1 ;
...
CREATE TABLE `venta_detalle` (
  ...
  KEY `venta_detalle_x_empresa` (`idEmpresa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Detalles de venta' AUTO_INCREMENT=1 ;
...
ALTER TABLE `compra_detalle`
  ADD CONSTRAINT `compra_detalle_ibfk_3` FOREIGN KEY (`idEmpresa`) REFERENCES `empresa` (`id`),
  ADD CONSTRAINT `compra_detalle_ibfk_4` FOREIGN KEY (`idCompra`) REFERENCES `compra` (`id`),
  ADD CONSTRAINT `compra_detalle_ibfk_5` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`id`);
...
ALTER TABLE `venta_detalle`
  ADD CONSTRAINT `venta_detalle_ibfk_5` FOREIGN KEY (`idEmpresa`) REFERENCES `empresa` (`id`),
  ADD CONSTRAINT `venta_detalle_ibfk_6` FOREIGN KEY (`idVenta`) REFERENCES `venta` (`id`),
  ADD CONSTRAINT `venta_detalle_ibfk_7` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`id`);
