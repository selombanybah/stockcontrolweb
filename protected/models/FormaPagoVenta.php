...
/**
 * This is the model class for table "forma_pago_venta".
 */
class FormaPagoVenta extends ActiveRecord
{
	/**
	 * The followings are the available columns in table 'forma_pago_venta':
	 * @var integer $id
	 ...
	 * @return FormaPagoVenta the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			...
			'ventas' => array(self::HAS_MANY, 'Venta', 'idFormaPagoVenta'),
		);
	}
